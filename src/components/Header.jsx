...
const Header = () => {
  ...
  // 3. Profile məlumatlarını hazırlayırıq
  const profile = menuData?.profile || {};
  
  // Şəkil yoxdursa default bir şəkil qoyuruq
  const bgImage = profile.background_img && profile.background_img !== "" 
  ...
  return (
    <div className="main-header-wrapper">
      <div
        ...
        style={{ backgroundImage: `url('${bgImage}')` }} // Dinamik Fon
      >
        <svg
        ...
        >
           ...
           <path d="M2.37162e-10 222.087C165.527 272.265 266.895 198.596 375 222.087C375 158.454 375 0 375 0H2.37162e-10C2.37162e-10 0 -2.96453e-10 191.683 2.37162e-10 222.087Z" fill="url(#paint0_linear_2822_7033)" />
           <defs>
            <linearGradient id="paint0_linear_2822_7033" x1="187.5" y1="240" x2="187.5" y2="0" gradientUnits="userSpaceOnUse">
            ...
            <div className="flag">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <g clipPath="url(#clip0_2821_7072)">
                    ...
                    <path d="M10.8 15.6C12.7882 15.6 14.4 13.9882 14.4 12C14.4 10.0118 12.7882 8.39999 10.8 8.39999C8.81176 8.39999 7.19998 10.0118 7.19998 12C7.19998 13.9882 8.81176 15.6 10.8 15.6Z" fill="white" />
                    <path d="M11.6 15C13.2569 15 14.6 13.6569 14.6 12C14.6 10.3431 13.2569 9 11.6 9C9.94315 9 8.60001 10.3431 8.60001 12C8.60001 13.6569 9.94315 15 11.6 15Z" fill="#EF3340" />
                    <path d="M14.8 10L15.1827 11.0761L16.2142 10.5858L15.7239 11.6173L16.8 12L15.7239 12.3827L16.2142 13.4142L15.1827 12.9239L14.8 14L14.4173 12.9239L13.3858 13.4142L13.8761 12.3827L12.8 12L13.8761 11.6173L13.3858 10.5858L14.4173 11.0761L14.8 10Z" fill="white" />
                  </g>
                  <defs>
          ...
          <div className="cafe-logo-circle" style={{ overflow: 'hidden' }}>
            {logoUrl ? (
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
                <path d="M16.6667 3.33334V6.66667" stroke="white" strokeWidth="3.33333" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M23.3333 3.33334V6.66667" stroke="white" strokeWidth="3.33333" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M26.6667 13.3333C27.1087 13.3333 27.5326 13.5089 27.8452 13.8215C28.1577 14.1341 28.3333 14.558 28.3333 15V28.3333C28.3333 30.1014 27.631 31.7971 26.3807 33.0474C25.1305 34.2976 23.4348 35 21.6667 35H11.6667C9.89856 35 8.20286 34.2976 6.95262 33.0474C5.70238 31.7971 5 30.1014 5 28.3333V15C5 14.558 5.17559 14.1341 5.48816 13.8215C5.80072 13.5089 6.22464 13.3333 6.66667 13.3333H30C31.7681 13.3333 33.4638 14.0357 34.714 15.286C35.9643 16.5362 36.6667 18.2319 36.6667 20C36.6667 21.7681 35.9643 23.4638 34.714 24.714C33.4638 25.9643 31.7681 26.6667 30 26.6667H28.3333" stroke="white" strokeWidth="3.33333" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M10 3.33334V6.66667" stroke="white" strokeWidth="3.33333" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            )}
          </div>
        </div>
